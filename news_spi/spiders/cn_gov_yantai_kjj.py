...
class CnGovYantaiKjjSpider(scrapy.Spider):

    name = "cn.gov.yantai.kjj"

    redis_key = "cn.gov.yantai.kjj"

    allowed_domains = ["kjj.yantai.gov.cn"]
    ...
    def start_requests(self):
        ...
        block = """
        curl 'https://kjj.yantai.gov.cn/col/col16248/index.html' \
  ...
  -H 'sec-ch-ua-platform: "macOS"'
        ...
        url = 'https://kjj.yantai.gov.cn/col/col16248/index.html'
