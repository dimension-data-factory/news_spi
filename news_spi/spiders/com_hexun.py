...
class ComHexunSpider(CrawlSpider):
    ...
    def start_requests(self):
        ...
        urls = [
                "https://tech.hexun.com/highlights/",
                "https://auto.hexun.com/cyzx/",
                "https://bank.hexun.com/yhhydt/",
                "https://insurance.hexun.com/bxjgdt/",
                "https://insurance.hexun.com/bxjrdd/",
                "https://insurance.hexun.com/bxscpl/",
                "https://insurance.hexun.com/2007/bxrsbd/",
                "https://insurance.hexun.com/bxzjyy/",
                "https://insurance.hexun.com/bxhyzx/",
                "https://insurance.hexun.com/bxgsxw/",
                "https://insurance.hexun.com/bxyxdt/",
                "https://futures.hexun.com/integratednews/",
                "https://futures.hexun.com/agriculturenews/",
                "https://futures.hexun.com/industrynews/",
                "https://futures.hexun.com/chemicalnews/",
                "https://futures.hexun.com/nyzx/",
                "https://futures.hexun.com/jwysp/",
                "https://funds.hexun.com/hotnews/",
                "https://funds.hexun.com/fundmarket/",
                "https://funds.hexun.com/report/",
                "https://stock.hexun.com/yanbaoplus/",
                "https://stock.hexun.com/tuoshuivyan/",
                "https://stock.hexun.com/zcxiaoxi/",
                "https://news.hexun.com/domestic/",
                "https://news.hexun.com/international/",
                "https://news.hexun.com/jsxw/",
                "https://news.hexun.com/shxw/",
                ]
        for url in urls:
            meta = {}
            meta['sub_domain'] = url.split('/')[2]
            yield Request(url=url, callback=self.parse, headers=self.headers, dont_filter=True, meta=meta)


    def parse(self, response):

        sub_domain = response.meta['sub_domain']
